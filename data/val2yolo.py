...
if __name__ == '__main__':
    ...
    root_path = 'D:/dxq/yolov5-face/widerface/'
    ...
    for idx, data in enumerate(datas.keys()):
        ...
        out_img = 'D:/dxq/yolov5-face/widerfaceyolo/val/images/{}.jpg'.format(idx)
        out_txt = 'D:/dxq/yolov5-face/widerfaceyolo/val/labels/{}.txt'.format(idx)
